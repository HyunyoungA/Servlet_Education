...
<body>
	...
	<div class="wrap">
		<nav>
			...
			<div class="menu" onclick="location.href='<%= request.getContextPath() %>/list.no'">NOTICE</div>
			<div class="menu" onclick="location.href='<%= request.getContextPath() %>/list.bo'">BOARD</div>
			<div class="menu" onclick="location.href='<%= request.getContextPath() %>/list.th'">IMAGE</div>
		</nav>
	</div>
