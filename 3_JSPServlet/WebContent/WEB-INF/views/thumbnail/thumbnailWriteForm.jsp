...
<body>
	...
	<div class="outer">
		...
		<form action="<%= request.getContextPath() %>/insert.th" method="post" encType="multipart/form-data"><!-- encType="multipart/form-data :파일을 보낼 때 필수적으로 인코딩타입지정이 필요하다!!(파일 전송/업데이트) 파일올리는 거기 때문에 -->
